...
type ListStreamWidgetDefinition struct {
	...
	Viz       ListStreamWidgetDefinitionSource `json:"viz"`
}
...
func NewListStreamWidgetDefinitionWithDefaults() *ListStreamWidgetDefinition {
	...
	this.Type = type_
	var viz ListStreamWidgetDefinitionSource = LISTSTREAMWIDGETDEFINITIONSOURCE_ISSUE_STREAM
	this.Viz = viz
	return &this
}
...
// GetViz returns the Viz field value
...
// GetVizOk returns a tuple with the Viz field value
// and a boolean to check if the value has been set.
...
func (o *ListStreamWidgetDefinition) UnmarshalJSON(bytes []byte) (err error) {
	...
	if required.Viz == nil {
		return fmt.Errorf("Required field viz missing")
	}
