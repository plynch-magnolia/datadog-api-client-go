 ...
 */
func (a *AWSIntegrationApiService) DeleteAWSAccount(ctx _context.Context, body AWSDeleteAccountRequest) (interface{}, *_nethttp.Response, error) {
