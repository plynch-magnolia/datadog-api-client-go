...
*FastlyIntegrationApi* | [**CreateFastlyIntegrationService**](docs/FastlyIntegrationApi.md#createfastlyintegrationservice) | **Post** /api/v1/integration/fastly/configuration/services | Create a new service object
*FastlyIntegrationApi* | [**DeleteFastlyIntegrationService**](docs/FastlyIntegrationApi.md#deletefastlyintegrationservice) | **Delete** /api/v1/integration/fastly/configuration/services/{service_id} | Delete a single service object
*FastlyIntegrationApi* | [**GetFastlyIntegrationService**](docs/FastlyIntegrationApi.md#getfastlyintegrationservice) | **Get** /api/v1/integration/fastly/configuration/services/{service_id} | Get a single service object
*FastlyIntegrationApi* | [**UpdateFastlyIntegrationService**](docs/FastlyIntegrationApi.md#updatefastlyintegrationservice) | **Put** /api/v1/integration/fastly/configuration/services/{service_id} | Update a single service object
...
## Documentation For Models
 ...
 - [FastlyServiceAccount](docs/FastlyServiceAccount.md)
 - [FastlyServiceId](docs/FastlyServiceId.md)
 - [FastlyServiceTags](docs/FastlyServiceTags.md)
